/*
 * File: app/view/consultaGeneral/winTramiteGeneral.js
 *
...
Ext.define('Tramites.view.consultaGeneral.winTramiteGeneral', {
    extend: 'Ext.window.Window',
    alias: 'widget.consultageneral.wintramitegeneral',

    requires: [
        'Tramites.view.consultar.winTramiteViewModel1',
        'Tramites.view.consultar.winTramiteViewController1',
        'Ext.form.Panel',
    ...
    controller: 'consultageneral.wintramitegeneral',
    viewModel: {
        type: 'consultageneral.wintramitegeneral'
    },
    height: 650,
    scrollable: true,
    width: 763,
