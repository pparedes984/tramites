/*
 * File: app/view/adminGeneral/UsuariosUnidadViewController.js
 *
...
Ext.define('Tramites.view.adminGeneral.UsuariosUnidadViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.admingeneral.usuariosunidad',

    onCbUsuarioBuscar3Keyup: function(textfield, e, eOpts) {
    ...
    onBtnLimpiarUsuarios3Click: function(button, e, eOpts) {
    ...
    onGrdUsuarioUnidadRender: function(component, eOpts) {
        this.onBtnLimpiarUsuarios3Click();
    },

    onGrdUsuarioUnidadSelect: function(rowmodel, record, index, eOpts) {
        var grid = Ext.getCmp('grdUsuarioUnidad');
        var arrayKeys = grid.getSelectionModel().selected.items;
        var txtusuario = arrayKeys[0].data.USR_USUARIO;
    ...
    onBtnAgregarUnidadUsuarioClick: function(button, e, eOpts) {
    ...
    onBtnQuitarUnidadUsuarioClick: function(button, e, eOpts) {
        var g = Ext.getCmp('grdUsuarioUnidad');
        var arrayKeys = g.getSelectionModel().selected.items;
        var indice = g.getSelectionModel().selectionStartIdx;
        if(arrayKeys.length === 0)
    ...
    onCbUnidadExpand: function(field, eOpts) {
        var g = Ext.getCmp('grdUsuarioUnidad');
        var reco = g.selection;
    ...
    onGrdUnidadesCellDblClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
