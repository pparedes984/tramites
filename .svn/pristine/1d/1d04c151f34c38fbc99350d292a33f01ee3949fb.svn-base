/*
 * File: app/view/administracion/AsuntosParametrosViewController.js
 *
...
Ext.define('Tramites.view.administracion.AsuntosParametrosViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.admingeneral.usuarioparametro',

    onCbParametroUsXPrmExpand: function(field, eOpts) {
    ...
    onCbParametroUsXPrmSelect: function(combo, record, eOpts) {
        Ext.getCmp('pnlContenedorUsr').setHidden(false);
        this.onBtnRefreshUsxPClick();
    },

    onBtnRefreshUsxPClick: function(button, e, eOpts) {
    ...
    onBtnAsignarUsrXParamClick: function(button, e, eOpts) {
        var me = this;
    ...
    onBtnQuitarUsrXParamClick: function(button, e, eOpts) {
        var me = this;
